...
import orthoticsWord from "../../assets/images/prostheticshomeimage.png";
import product2Img from "../../assets/images/prostheticshomeproductimage.png";
  ...
  return (
    <section className="orthotics-hero">
      ...
      <div className="orthotics-center">
        <img src={product2Img} alt="Orthotic device" className="orthotics-product2" />
        <img src={vectorLine} alt="" className="orthotics-vector2" />
      </div>
